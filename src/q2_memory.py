...
def q2_memory(file_path: str) -> List[Tuple[str, int]]:
    ...
    # Define local function to extract emojis from text
    ...
    # Create a new DataFrame with exploded Array of emojis using UDF
    emoji_df = df.withColumn('emoji', explode(extract_emojis_udf(df['post_text'])))

    # Count emojis and order by frequency and alphabetical order for tie-breaking
